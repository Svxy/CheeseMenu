...
namespace big
{
	...
	voice_chat_audio g_voice_chat_audio("vcaudio", "Play Audio Through Voice Chat", "Plays an audio.wav file in the project folder through voice chat. The wave file must be encoded with a mono 16 bit 16kHz PCM format. You have to reset voice chat settings whenever you load CheeseMenu for the audio to play correctly.",
